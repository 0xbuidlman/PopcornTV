...
public class LibTorrent {
	 ...
	 * @return
	 */
	public native boolean SetSession(int ListenPort, int UploadLimit, int DownloadLimit, boolean Encryption);
	 ...
	 */
	public native boolean AddTorrent(String SavePath, String TorentFile, int StorageMode, boolean IsMagnet);
	 ...
	 * 7 checking_resume_data } + 8 paused
	 */
